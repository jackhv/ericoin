...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\ERIcoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\ERIcoin
    // Mac: ~/Library/Application Support/ERIcoin
    // Unix: ~/.ERIcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "ERIcoin";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "ERIcoin.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
    {
            boost::filesystem::path ConfPath;
                   ConfPath = GetDefaultDataDir() / "ERIcoin.conf";
                   ...
                   fprintf(ConfFile, "port=15565\n");
                   fprintf(ConfFile, "rpcport=15566\n");
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "ERIcoind.pid"));
